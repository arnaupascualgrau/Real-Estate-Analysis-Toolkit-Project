...
def test_data_loading_and_cleaning():
    ...
    # Test data loading
    data_path = Path("real_estate_toolkit/files/train.csv")
...
def test_market_analyzer():
    ...
    dataset_path = Path("real_estate_toolkit/files/train.csv")
    analyzer = MarketAnalyzer(data_path=str(dataset_path))
    # Test cleaning data
    try:
        analyzer.clean_data()
        assert analyzer.real_estate_clean_data is not None, "Cleaned data is None."
...
def test_house_price_predictor():
    ...
    train_data_path = Path("real_estate_toolkit/files/train.csv")
    test_data_path = Path("real_estate_toolkit/files/test.csv")
